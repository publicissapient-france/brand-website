<nav class="menu-footer">
	<a class="<?php if($page=='logos'){?>active<?}?>" href="logos.php">
	...
	<a class="<?php if($page=='colors'){?>active<?}?>" href="colors.php">
	...
	<a class="<?php if($page=='fonts'){?>active<?}?>" href="fonts.php">
	...
	<a class="<?php if($page=='assets'){?>active<?}?>" href="assets.php">
	...
	<a class="<?php if($page=='slides'){?>active<?}?>" href="slides.php">
