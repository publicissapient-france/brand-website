<nav class="menu-footer">
	<a class="<?php if($page=='logos'): ?>active<?php endif; ?>" href="logos.php">
	...
	<a class="<?php if($page=='colors'): ?>active<?php endif; ?>" href="colors.php">
	...
	<a class="<?php if($page=='fonts'): ?>active<?php endif; ?>" href="fonts.php">
