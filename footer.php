<nav class="menu-footer">
	<a class="<?php if($page=='logos') ?>active<? endif; ?>" href="logos.php">
	...
	<a class="<?php if($page=='colors') ?>active<? endif; ?>" href="colors.php">
	...
	<a class="<?php if($page=='fonts') ?>active<? endif; ?>" href="fonts.php">
	...
	<a class="<?php if($page=='assets') ?>active<? endif; ?>" href="assets.php">
	...
	<a class="<?php if($page=='slides') ?>active<? endif; ?>" href="slides.php">
