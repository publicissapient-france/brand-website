	...
	<body>
		...
		<div class="content">
			...
			<div class="card-container">
				...
				<div class="card">
				<div class="cercle cercle-socialmedia"></div>
				...
				<div class="card">
				<div class="cercle cercle-templateslide"></div>
					<h2>Template Slide</h2>
					<h3>GSLIDE</h3>
					<div class="liste">
						<ul class="un">
							<li><a href="https://drive.google.com/open?id=1VWHBjyLK2Zi4qeurkZmk0lv2gG5_RI6p" target="new">Talk</a></li>
				...
				<div class="card">
				<div class="cercle cercle-whois"></div>
					<h2>Whois</h2>
					<h3>JPG & GSLIDE</h3>
					<div class="liste">
						<ul class="un">
							<li><a href="https://drive.google.com/open?id=1A-w14mrdMcevFlL0uKaLyjweyLcDxzav" target="new">Photos</a></li>
				...
				<div class="cercle cercle-signature"></div>
					...
					<div class="liste">
						<ul class="un">
							...
							<li><a href="https://drive.google.com/open?id=1vEa_Gr6QsDBIw3y_bANyxid6dRoXi6AU" target="new">Events</a></li>
							<li><a href="https://drive.google.com/open?id=1apuF283VIgUxFAXkEczNDnIzX-JDIf7s" target="new">Annonces</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="cercle cercle-techtrends"></div>
					...
					<div class="liste">
						<ul class="un">
							<li><a href="https://drive.google.com/open?id=1FjVWoyvVtNBm6wP7UMm6f3N7ymlZ8J1R" target="new">Covers</a></li>
							<li><a href="https://drive.google.com/open?id=1jrJ2kg-MDa7rPjdtEQorUrVpzbIvVtn8" target="new">PDF</a></li>
							<li><a href="https://drive.google.com/open?id=1zzR8a_taJPHDAtKD1QGTPq5T_wqM6q-t" target="new">Illustrations</a></li>
							<li><a href="https://drive.google.com/open?id=1Wz5rHpHq5Lhoo5vG26cIs83fh5k-UCx6" target="new">Image Bank</a></li>
						</ul>
					</div>
				</div>
